...
## Background: 
- Until now, when the user is not logged-in and runs the checkout workflow, he/she can not finish the workflow. This is very annoying for the user.

## User Story: Login during checkout workflow
- As a user who is not logged in I want the possibility to perform a login during the checkout workflow to be able to finish the workflow.

## Acceptance Criteria:

### UC1: User is not logged-in
- Given the user is not logged-in 
- And on the checkout-UI When the user clicks "Proceed to Checkout" 
