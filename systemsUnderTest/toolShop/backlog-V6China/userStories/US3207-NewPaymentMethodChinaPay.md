...
## Background: 
- Toolshop wants to enter the China market and must offer additional payment method.

## User Story: Enable China Pay as payment method
- As a shop owner, I want that the user can pay with China Pay to offer an additional payment method.
