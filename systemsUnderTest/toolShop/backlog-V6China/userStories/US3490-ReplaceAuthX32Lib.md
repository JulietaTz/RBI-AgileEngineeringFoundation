...
## Background: 
- A security scan found a vulnerability X2499 in the used open-source library "Auth-X32". According to ISECC-2499 the lib should be replaced with the lib "Auth-XX64"
